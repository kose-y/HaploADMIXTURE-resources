...
for K in 2:11
    p = readdlm("TGP_1718_1854622_K$(K)_2_haplo_p.txt")
    q = readdlm("TGP_1718_1854622_K$(K)_2_haplo_q.txt")
...
# HaploADMIXTURE.init_em!(d, g, 5; d_cu=d_cu, g_cu=g_cu)
        ...
        q_train = copy(d.q)
        p_train = copy(d.p)
        writedlm("train_fold$(fold)_K$(K)_2_haplo_q.txt", q_train)
        writedlm("train_fold$(fold)_K$(K)_2_haplo_p.txt", p_train)
    end
end
